...
const log = {
    loading: (text = "", enabledots = true) => {
        ...
        const interval = setInterval(function() {
            ...
            process.stdout.write("\r" + chars[x++] + " " + text + (enabledots ? dots[x % dots.length] : ""));
            x = x % chars.length;
        }, delay);
        ...
        return {
            finish: (text1 = text) => {
                ...
                process.stdout.write("\r\x1b[32m\x1b[1m\u2713\x1b[0m " + text1 + "                                      \n");
            },
            error: (text1 = text) => {
                clearInterval(interval);
                process.stdout.write("\r\x1b[31m\x1b[1m\u2717\x1b[0m " + text1 + "                                      \n");
            },
        }
    },
    error: (text) => {
